...
class TaskManagerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Управления задачами ")
    ...
    def create_widgets(self):
        ...
        tk.Label(self.root, text="Название задачи:").grid(row=0, column=0, sticky="w")
        ...
        tk.Label(self.root, text="Срок погашения:").grid(row=2, column=0, sticky="w")
        ...
        self.task_list_treeview.heading("#0", text="Название задачи")
        self.task_list_treeview.heading("Priority", text="Приоритет")
        self.task_list_treeview.heading("Due Date", text="Срок погашения")
        ...
        # Clear Task Button
        clear_task_button = tk.Button(self.root, text="Очистить поля", command=self.clear_task)
